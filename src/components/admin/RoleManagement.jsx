        ...
        <div className="space-y-6">
            <Card className="backdrop-blur-sm bg-card/80 border-border/50">
                <CardHeader>
                    ...
                    <CardDescription>Benutzerrollen im System verwalten und Anfragen freischalten</CardDescription>
                </CardHeader>
                <CardContent>
                    <RoleManagementTable />
                </CardContent>
            ...
            <Card className="backdrop-blur-sm bg-card/80 border-border/50">
                <CardHeader>
                    ...
                    <CardDescription>Komplette Übersicht des verknüpften Discord Servers</CardDescription>
                </CardHeader>
                <CardContent>
                    <MembersView />
                </CardContent>
